        ...
        <div className='h-[100vh] flex justify-center items-center bg-c1'>
            <div className='flex items-center flex-col'>
                ...
                <form className='flex flex-col center gap-3 w-[500px] mt-5'>
                    ...
                    <input type="text" placeholder='Email' className='w-full h-14 bg-c5 rounded-xl outline-none border-none px-5 text-c3' autoComplete='off' />
                ...
                <div className='flex justify-center gap-1 text-c3 mt-5'>
                    ...
                    <Link href='/register' className='font-semibold text-white underline-offset-2 cursor-pointer'>
                        Register Now
                    </Link>
                </div>
